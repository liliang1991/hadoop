...
public class FileSystemImageSerialization {


        // Static-only class
        private FileSystemImageSerialization() {}
        ...
        static INodeFileUnderConstruction readINodeUnderConstruction(
            ...
            long inodeId = LayoutVersion.supports(LayoutVersion.Feature.ADD_INODE_ID, imgVersion) ? in
            ...
            if(numBlocks > 0) {
                ...
                blocks[i] = new BlockInfoUnderConstruction(
                        blk, blockReplication, HdfsServerConstants.BlockUCState.UNDER_CONSTRUCTION, null);
            }
        ...
        private static void writeINodeReference(INodeReference ref, DataOutput out,
                                                boolean writeUnderConstruction, SnapshotFSImageFormat.ReferenceMap referenceMap
        ) throws IOException {
